...
class Localization implements Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en': {
          ...
          "Confirmation Password is too short":
              "Confirmation Password is too short must bee\n at least 8 digits",
          ...
          "Enter card": "Enter card number to be charge on your wallet",
          "Please Enter card": "Please Enter card number",
          "Ex:": "Ex: 198787898",
        ...
        'ar': {
          ...
          "Please Enter your Current Password":
              "الرجاء إدخال كلمه المرور الحاليه",
          "Please Enter your New Password": "الرجاء إدخال كلمه المرور الجديده",
          "Please Re-Enter your password": "الرجاء قم بتأكيد كلمة المرور",
          "Password is too short": "كلمة المرور يجب ان تكون علي الأقل ٨ أحرف",
          "Confirmation Password is too short":
              "تأكيد كلمه المرور يجب ان تكون علي الأقل ٨ أحرف",
          ...
          "History": "السجلات",
          "E-government": "الرسوم الحكوميه",
          "Cards": "إداره البطاقات",
          "Other": "أخري",
          ...
          "Password Update": "تعديل كلمه المرور",
          "Language": "اللغة",
          ...
          "Enter card number": "أدخل رقم الكرت",
